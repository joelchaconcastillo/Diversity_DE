...
%
The former records the vector with the best finess of each Target vector, therefore there are $N$ elite vectors, which can be considered as multi-set since that they could be the same.
%
