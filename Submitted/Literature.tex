...
Most \EAS{} start with a set of diverse candidate solutions, and as the generations evolve, such a diversity 
is reduced \cite{Crepinsek:13}.
%
This reduction on diversity might lead to premature convergence, which in fact is a common drawback in \EAS{}.
%
Thus, several variants to deal with this issue have been designed \cite{eshelman1993real}.
%
...
%
In \RTS{} after a new individual ($C$) is created, $CF$ individuals from the current population are randomly selected.
%
...
%
Then, the rankings are combined to generate the biased fitness value $BF(I)$ using Eq. \ref{eqn:biased}.
%
...
\DE{} is highly susceptible to the loss of diversity, partially due to the greedy strategy applied in the selection phase.
%
...
%
Instead, restrictions apply to the differences appearing in the reproduction phase.
