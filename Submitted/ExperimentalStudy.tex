...
%\begin{scriptsize}
\centering
\caption{Summary of the results obtained by \DEEDM{} and state-of-the-art algorithms- \CEC{} 2016}
...
%\begin{scriptsize}
\centering
\caption{Summary of the results obtained by \DEEDM{} and state-of-the-art algorithms - \CEC{} 2017}
...
%
Based on preliminary analyses, the \RTS{} was executed with a sample size $CF=25$, 
and \HGSADC{} was executed with $N_{Close} = 1$, and $N_{Elite}=8$.
%
...
for both benchmarks with the same meaning that in the previous experiment.
%
...
%
Note that the main difference of our proposal in constrast to the schemes \RTS{} and \HGSADC{} lies in the fact
that they provide modifications with the aim of delaying convergence but in an indirect way, 
meaning that premature convergence might not always be avoided.
%
%Thus, \RTS{} and \HGSADC{} might search for a long period in just a few sub-optimal regions.
%
...
%
Thus, advantages of incorporating \RTS{} and \HGSADC{} in \DE{} are diminished.
%
%so the benefits of incorporating them in \DE{} seems to be much more reduced.
%
Therefore, making decisions by taking into account the stopping criterion and elapsed generations seems
to be the key to properly avoid premature convergence in long-term executions.
...
\begin{table}[t]
\centering
\caption{Summary of the results obtained with different replacement strategies - \CEC{} 2016}
...
\begin{table}[t]
\centering
\caption{Summary of the results obtained with different replacement strategies - \CEC{} 2017}
