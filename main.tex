...
%
In this paper, a novel replacement strategy that combines the use of an elite population and a mechanism to preserve diversity explicitly
is devised.
...
Author acknowledge the financial support from CONACyT through the ``Ciencia B\'asica'' project no. 285599.
